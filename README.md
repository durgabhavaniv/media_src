...
export LIBVA_DRIVER_NAME=iHD
export LIBVA_DRIVERS_PATH=$ROOT_INSTALL_DIR/lib/dri
export PATH=/opt/media_new/share/mfx/samples/:/opt/media_new/bin:$PATH
export CPPFLAGS="-I/opt/media_new/include $CPPFLAGS"
export CFLAGS="-I/opt/media_new/include $CFLAGS"
export CXXFLAGS="-I/opt/media_new/include $CXXFLAGS"
which ffmpeg
